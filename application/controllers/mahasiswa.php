...
class Mahasiswa extends CI_Controller{
    ...
    public function excel(){
        ...
        require(APPPATH. 'PHPExcel-1.8/Classes/PHPExcel/Writer/
            Excel2007.php');
        
        $object = new PHPExcel();

        $object->getProperties()->setCreator("Proyek Harit");
        $object->getProperties()->setLastModifiedBy("Proyek Harit");
        ...
        $writer=PHPExcel_IOFactory::createrwriter($object, 'Excel2007');
