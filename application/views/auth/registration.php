<div class="container">
    ...
    <div class="row mx-auto">
        <div class="col mx-auto my-3">
            <h2 style="text-align: center;">Registrasi Donatur</h2>
            <hr>
        </div>
    </div>
    <div class="row">
        <div class="col-md-7">
            <div class="card o-hidden border-0 shadow-lg mb-5 col-lg-12 mx-auto">
                <div class="card-header">
                    <b>Lokasi Anda </b>| geser marker untuk menandai lokasi anda
                </div>
                            ...
                            <div class="p-4">
                                <form class="user" method="post" action="<?= base_url('auth/registration'); ?>">
                                    <div class="form-group">
                                        <label class="d-block">Nama Anda</label>
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Nama Anda" value="<?= set_value('name'); ?>">
                                    ...
                                    <div class="form-group">
                                        <label for="alamat" class="d-block">Alamat Anda</label>
                                        <input id="alamat" type="text" class="form-control" name="alamat" placeholder="Alamat Anda">
