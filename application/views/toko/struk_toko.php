    ...
    foreach ($kayu as $ky) :
        if($ky->status_order == 3 )
        {
         ...
         ?>
            ...
            <td>
            <a href="<?php echo base_url() . 'toko/struk_toko/detail/'.$ky->id?>" class="btn btn-secondary btn-md btn-icon-split">
            ...
            ||
            <a target="_blank" type="button" href="<?php echo site_url() . 'toko/struk_toko/cetak/'.$ky->id?>" class="btn btn-info btn-md btn-icon-split">
                                        <span class="icon text-white-50">
