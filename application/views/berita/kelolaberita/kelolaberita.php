...
<div class="container-fluid">
  ...
  <div class="row my-3">
    <div class="col-md-6">
      ...
      <a href="#" data-toggle="modal" data-target="#tambahberitaModal" class="btn btn-primary ml-3"><i class="fas fa-plus"></i> Tambah Berita</a>
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      <div class="table-responsive">
        <a class="btn btn-sm btn-success mb-3" href="<?php echo base_url() ?>berita/cetak_berita/"><i class="fas fa-print"></i> Print Data Berita</a>
            ...
            ?>
              <tr>
                ...
                <td class="text-center">
                  <a href="<?= base_url(); ?>berita/detail_berita/<?= $b['id']; ?>" class="badge badge-primary"><i class="fas fa-fw fa-eye"></i></a>
                  <a href="#" data-toggle="modal" data-target="#editberitaModal<?= $b['id']; ?>" class="badge badge-success"><i class="fas fa-fw fa-edit"></i></a>
                  <a href="" class="badge badge-danger" data-toggle="modal" data-target="#hapusberitamodal<?= $b['id']; ?>">delete</a>

                  <div class="modal fade" id="hapusberitamodal<?= $b['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal fade" id="tambahberitaModal" tabindex="-1" role="dialog" aria-labelledby="tambahberitaModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <?= form_open_multipart('berita/tambah_berita'); ?>
  ...
  <div class="modal fade" id="editberitaModal<?= $b['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editberitaModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="<?= base_url(); ?>berita/edit_berita/<?= $b['id']; ?>" method="post" enctype="multipart/form-data">
          <input type="hidden" name="id" value="<?= $b['id']; ?>">
          <div class="modal-body">
            <div class="form-group">
              <label>Judul Berita</label>
